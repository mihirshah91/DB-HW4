...
public class PointToClusterMapper extends Mapper<Text, Text, Text, Text>
{
	...
	public void map(Text key, Text value, Context context)
		...
		System.out.println("inside mapper");
            ...
            // compute the distance of the point from every centroid and emit the centroid, point
            float distance;
            ...
            System.out.println("centroid for the point " + p.toString()+" is "+ centroid.toString());
